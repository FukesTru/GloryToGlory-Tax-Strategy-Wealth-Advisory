...
export interface ServicesHubContent {
  ...
  h1: string;
  heroSub: string;
  /** 150–200 words framing the six services as one system. */
  intro: string[];
  gridTitle: string;
...
export const servicesHubPage: L<ServicesHubContent> = {
  en: {
    ...
    metaDescription:
      "Six coordinated services for tech professionals: financial planning, tax strategy, equity compensation, retirement, education funding and asset allocation.",
    eyebrow: "Services",
    h1: "Financial Planning & Tax Strategy Services",
    heroSub: "Six services that work as one system, so every decision about your equity, taxes and savings supports the others.",
    intro: [
      ...
      "That is why we do not sell services one at a time. Holistic financial planning is the frame. Tax strategy sets the calendar. Equity compensation planning decides what you hold and sell. Retirement and education planning define what the money is for. Asset allocation turns it all into a portfolio you can live with. Start with the service that matches today's question, and we will show you how it connects to the rest.",
    ],
  ...
  "zh-hant": {
    ...
    metaDescription:
      "為科技業專業人士提供六項協調一致的服務：財務規劃、稅務策略、股權獎酬、退休規劃、教育基金與資產配置。",
    eyebrow: "服務項目",
    h1: "財務規劃與稅務策略服務",
    heroSub: "六項服務如同一個系統運作，讓您在股權、稅務與儲蓄上的每個決定都能相互支持。",
    intro: [
      ...
      "這就是為什麼我們不會逐項販售服務。全方位財務規劃是整體框架，稅務策略排定時程，股權獎酬規劃決定該持有與出售什麼，退休與教育規劃定義金錢的用途，而資產配置則把一切變成一個您能安心持有的投資組合。從最符合您當下問題的服務開始，我們會告訴您它如何與其他環節相連。",
    ],
    gridTitle: "選擇您的起點",
    equityNote: {
      title: "深入了解股權獎酬",
